 ...
 */
 ...
 console.log("*************************** start ng sortable **********************************************");
(function () {
	'use strict';
    console.log('****************** prime ng sortable ***********************')
	...
	factory(window.angular, window.Sortable);
function  factory (angular, Sortable) {
	'use strict';
	...
	var expando = 'Sortable:ng-sortable';
     console.log("********************* register ng-sortabel ***********************")
